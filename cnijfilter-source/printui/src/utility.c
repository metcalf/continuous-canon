...
static short		pss_value;		
static short		current_pss_value;		

static short		roller_cleaning_type_a_value;	
static short		nozzle_check_type_a_value;	
static short		nozzle_check_type_a_prev_value;	
static short		is2nd_exec_nozlle_check;	

static short		head_alignment_type_a_value;	

static short		check_alignment_setting_type_a_value;	

static short		isPermitCancel;	
...
RegiDialogTable regi_dialog_table[]=
{
	...
	{IDM_MX_860,	create_regi_type_i1_dialog,  create_regi_type_i2_dialog, create_regi_type_i3_dialog, NULL },
	{IDM_MX_320,	create_IP2200regi_dialog,   create_TYPE_G_regi2_dialog, NULL, NULL },
	{IDM_MX_330,	create_IP2200regi_dialog,   create_TYPE_G_regi2_dialog, NULL, NULL },
	{IDM_MP_250,	create_regi_type_j1_dialog,   create_regi_type_j2_dialog, create_regi_type_j3_dialog, NULL },
	{IDM_MP_270,	create_regi_type_j1_dialog,   create_regi_type_j2_dialog, create_regi_type_j3_dialog, NULL },
	{IDM_MP_490,	create_regi_type_j1_dialog,   create_regi_type_j2_dialog, create_regi_type_j3_dialog, NULL },
	{IDM_MP_550,	create_regi_type_k1_dialog,   create_regi_type_i2_dialog, create_regi_type_i3_dialog, NULL },
	{IDM_MP_560,	create_regi_type_k1_dialog,   create_regi_type_i2_dialog, create_regi_type_i3_dialog, NULL },
	{IDM_IP_4700,	create_regi_type_k1_dialog,   create_regi_type_i2_dialog, create_regi_type_i3_dialog, NULL },
	{IDM_MP_640,	create_regi_type_k1_dialog,   create_regi_type_i2_dialog, create_regi_type_i3_dialog, NULL },
	{IDM_IP_2700,	create_regi_type_j1_dialog,   create_regi_type_j2_dialog, create_regi_type_j3_dialog, NULL },
	{IDM_MX_340,	create_regi_type_j1_dialog,   create_regi_type_j2_dialog, create_regi_type_j3_dialog, NULL },
	{IDM_MX_350,	create_regi_type_j1_dialog,   create_regi_type_j2_dialog, create_regi_type_j3_dialog, NULL },
	{IDM_MX_870,	create_regi_type_k1_dialog,   create_regi_type_i2_dialog, create_regi_type_i3_dialog, NULL },
	{NULL, NULL}
};
...
static void UtilNozzleCheckWithoutCheckPattern(LPUIDB uidb);
static int SetCurrentTimeNoBJL( char *buf );
...
static void OutputBJLCommandTypeB( char *cmdPtr, int cmdSize )
{
	...
	if ( isAllOutputSetTime( model_name ) ){
		cmd_bytes = SetCurrentTimeNoBJL(p); p+=cmd_bytes;
	} 
...
static void CheckAlignmentSetting(GtkWidget *widget)
{
	...
	if( !strcmp(GetModelName(), IDM_IP_3300 ) || 
		...
		!strcmp(GetModelName(), IDM_MP_240 ) ||
 		!strcmp(GetModelName(), IDM_MX_320 ) || !strcmp(GetModelName(), IDM_MX_330 ) )  { // 2008/11/28
		;
	}
...
static void CheckAlignmentSetting2TypeB( GtkWidget *widget )
{
	/* output BJL */
	OutputBJLCommandTypeA( BJLREGICHECK, BJLREGICHECKLEN );
...
static void CheckAlignmentSetting2(GtkWidget *widget)
{
	...
	if ( !strcmp( model_name, IDM_IP_4600 ) || !strcmp( model_name, IDM_MP_630 ) ||
		 !strcmp( model_name, IDM_MP_550 ) || !strcmp( model_name, IDM_MP_560 ) ||
		 !strcmp( model_name, IDM_IP_4700 ) || !strcmp( model_name, IDM_MP_640 ) ||
		 !strcmp( model_name, IDM_MX_870 )	){
		if ( manual_head_mode == 0 ){	// auto
			...
			CheckAlignmentSetting2TypeAManual( widget );
				...
				!strcmp( model_name, IDM_MX_860 ) ) {
		CheckAlignmentSetting2TypeAManual( widget );
	}
	else if ( !strcmp( model_name, IDM_MP_250 ) || !strcmp( model_name, IDM_MP_270 ) || !strcmp( model_name, IDM_MP_490 ) ||
			  !strcmp( model_name, IDM_IP_2700 ) || !strcmp( model_name, IDM_MX_340 ) || !strcmp( model_name, IDM_MX_350 )) {
		CheckAlignmentSetting2TypeB( widget );
	}
	else goto EXIT;
	...
	short kindcnt)                  
{
	...
	model_name = GetModelName();		
	if ( !strcmp( model_name, IDM_MP_250 ) || !strcmp( model_name, IDM_MP_270 ) || !strcmp( model_name, IDM_MP_490 ) ||
		 !strcmp( model_name, IDM_IP_2700 ) || !strcmp( model_name, IDM_MX_340 ) || !strcmp( model_name, IDM_MX_350 ) ){
		DrawTestPrintPage( regi_dialog, pixmap, hotspot, ctrlitem, items, group, kindcnt, 1 );                 
	}
	else {
		DrawTestPrintPage( regi_dialog, pixmap, hotspot, ctrlitem, items, group, kindcnt, 0 );                 
	}
}
	...
	for (i=0; i<kindcnt; i++) {		
		...
		if (hotspot[i].repeat) {	
			...
			if (group == i)		
		 	...
		 	y = hotspot[i].drawy;
		 	box_width = hotspot[i].width;
		 	//box_height = (!strcmp(GetModelName(), "BJF850"))?  hotspot[i].len*2-1 : hotspot[i].len*2;
			if ( isOddHeight == 1 ){
				box_height = hotspot[i].len*2-1;
			}
			else {
				box_height = hotspot[i].len*2;
			}
		 	for (j=0; j<hotspot[i].cnt; j++, x+=nStepX, y+=nStepY) {	
		 		int		startx, starty;
		 		startx = x - nOffsetX;	
...
int UtilRegiDialog(short page)
{
	...
	DrawTestPrintPage2(regi_dialog,
	...
	GtkWidget *widget, GdkEventButton *event, gpointer user_data)
{
	...
	DrawTestPrintPage2(dialog, regi_pixmap,
		HotSpot, lpCtrlItem, items, current, nKindCnt);

	// focus spinbutton ver.3.20
	spin_button = LookupWidget( dialog, lpCtrlItem[current].CtrlName );
...
void on_regi_spinbutton_changed(GtkSpinButton *spinbutton, gpointer user_data)
{
	...
	for (i=0; i<nKindCnt; i++) {
		items[i] = gtk_spin_button_get_value_as_int(
			GTK_SPIN_BUTTON(LookupWidget(GTK_WIDGET(spinbutton), lpCtrlItem[i].CtrlName)));
	}

	DrawTestPrintPage2(dialog, regi_pixmap, HotSpot, lpCtrlItem,
...
// 2009/04/16
void
on_regi_auto_type_a1_dialog_destroy    (GtkObject       *object,
                                        gpointer         user_data)
{
	gtk_main_quit();
}
...
gboolean
on_regi_auto_type_a1_dialog_delete_event
                                        (GtkWidget       *widget,
                                        GdkEvent        *event,
                                        gpointer         user_data)
{
...
void
on_regi_auto_type_a1_cancel_button_clicked
                                        (GtkButton       *button,
                                        gpointer         user_data)
{
	result = ID_CANCEL;
...
void
on_regi_auto_type_a1_check_setting_button_clicked
                                        (GtkButton       *button,
                                        gpointer         user_data)
{
#ifdef USE_LIB_GLADE
...
void UtilCleaning(LPUIDB uidb)
{
	...
	if(	!strcmp(model_name, IDM_IP_3300) || 			
			...
			!strcmp(model_name, IDM_IP_3600) ||		
			!strcmp(model_name, IDM_IP_4600) ||
			!strcmp(model_name, IDM_MP_630) ||
			!strcmp(model_name, IDM_MP_540) ||
			!strcmp(model_name, IDM_MP_240) ||
			!strcmp(model_name, IDM_MX_860) ||
			!strcmp(model_name, IDM_MX_320) ||
			!strcmp(model_name, IDM_MX_330) ||
			!strcmp(model_name, IDM_MP_250) || !strcmp(model_name, IDM_MP_270) || !strcmp(model_name, IDM_MP_490) ||
			!strcmp(model_name, IDM_MP_550) || !strcmp(model_name, IDM_MP_560) || 
			!strcmp(model_name, IDM_IP_4700) || !strcmp(model_name, IDM_MP_640)||
			!strcmp(model_name, IDM_IP_2700) ||
			!strcmp(model_name, IDM_MX_340) || !strcmp(model_name, IDM_MX_350) ||
			!strcmp(model_name, IDM_MX_870) ){
	...
	if( !strcmp(model_name, IDM_MP_160) ||
			 ...
			 !strcmp(model_name, IDM_IP_2600) || !strcmp(model_name, IDM_MP_190) ||	
...
/* Head Refreshing ******************************************************************/
// 2008/12/01
static void UtilRefreshingTypeZZZ(LPUIDB uidb)
{
	char		buf[128];
	char		*p = buf;
	char		*model_name;
	...
	if( !strcmp(model_name, IDM_MP_160 ) ||
		...
		if ( !strcmp(model_name, IDM_MP_240) ){
			gtk_label_set_text(
...
static int GetInkMsgInfoIndex( char *model_name )
{
	int index = -1;
	int i;
...
static int ShowRefreshingUITypeA( LPUIDB uidb,char *keyStr )
{
	GtkWidget* refreshing_dialog = NULL;
	GtkWidget* radio_button;
	GtkWidget* excute_button;
	...
	if ( keyStr != NULL ){
		gtk_label_set_text(
			GTK_LABEL(LookupWidget(refreshing_dialog, "refreshing_label1")),
			LookupText(g_keytext_list, keyStr));
	}
	else {
		gtk_label_set_text(
			GTK_LABEL(LookupWidget(refreshing_dialog, "refreshing_label1")),
	...
	index = GetInkMsgInfoIndex( model_name );
	index = (index == -1)? 0 : index;

	/* All Ink */
	radio_button = LookupWidget(refreshing_dialog, "refreshing_radiobutton1");
		gtk_label_set_text(GTK_LABEL((GTK_BIN(radio_button))->child),	
		LookupText(g_keytext_list, InkMsgInfo[index].InkName[0]));

	/* Black Ink */
	radio_button = LookupWidget(refreshing_dialog, "refreshing_radiobutton2");
		gtk_label_set_text(GTK_LABEL((GTK_BIN(radio_button))->child),	
		LookupText(g_keytext_list, InkMsgInfo[index].InkName[1]));

	/* Color Ink */
	radio_button = LookupWidget(refreshing_dialog, "refreshing_radiobutton3");
	...
	msg = LookupText(g_keytext_list, InkMsgInfo[index].RefMsg[refresh_head_type]);
...
static void OutputRefreshingBJLTypeA( LPUIDB uidb )
{
	CLEANCMD *refreshing_cmd;
	char* model_name;
	int index;
	...
	OutputBJLCommandTypeA( refreshing_cmd[refresh_head_type].cmd, refreshing_cmd[refresh_head_type].len);
}

static int UtilRefreshingTypeA( LPUIDB uidb )
{
	char		*model_name;
	int ret = 1;
	model_name = GetModelName();
	...
	/* show ui */
	if ( ShowRefreshingUITypeA( uidb, NULL ) != 0 ){
		goto EXIT;
	}

	/* output BJL */
	OutputRefreshingBJLTypeA( uidb );

	/* show wait dialog */
	UtilMessageBox(LookupText(g_keytext_list, "LUM_IDS_MNTMSG_UNTILFINISH_DEEPCLEANING"),
		g_window_title, MB_ICON_EXCLAMATION | MB_OK);

	/* Print NozzleCheckPattern */
	UtilNozzleCheckWithoutCheckPattern( uidb );
...
static int UtilRefreshingTypeB( LPUIDB uidb )
{
	char		*model_name;
	int ret = -1;
	model_name = GetModelName();
	...
	/* show ui */
	if ( ShowRefreshingUITypeA( uidb, "LUM_IDS_CLEAN_TOPIC_DEEP_EX_3" ) != 0 ){
		goto EXIT;
	}
...
void UtilRefreshing(LPUIDB uidb)
{
	...
	if ( !strcmp(model_name, IDM_MX_860 ) ||
		 !strcmp(model_name, IDM_MP_550 ) || !strcmp(model_name, IDM_MP_560 ) ||
		 !strcmp(model_name, IDM_IP_4700 ) || !strcmp(model_name, IDM_MP_640) ||
		  !strcmp(model_name, IDM_MX_870)) {
		UtilRefreshingTypeA( uidb );
	}
	else if ( !strcmp(model_name, IDM_MX_320 ) || !strcmp(model_name, IDM_MX_330 ) ||
		 	  !strcmp(model_name, IDM_MP_250 ) || !strcmp(model_name, IDM_MP_270 ) ||  !strcmp(model_name, IDM_MP_490) ||
			  !strcmp(model_name, IDM_IP_2700) || !strcmp(model_name, IDM_MX_340) ||  !strcmp(model_name, IDM_MX_350) ){
		UtilRefreshingTypeB( uidb );
	}
	else {
		UtilRefreshingTypeZZZ( uidb );
	}
...
static int PrintNozzleCheckTypeA ( LPUIDB uidb, char *keyStr )
{
...
static int CheckNozzleCheckTypeA ( LPUIDB uidb, char *keyStr )
{
	int	i;
	int return_val = -1;
	char *model_name;
...
static void NozzleCheckTypeA ( LPUIDB uidb, char *keyStr )
{

	if ( PrintNozzleCheckTypeA ( uidb, keyStr ) != 0 ){
		goto EXIT;
	}
	if ( CheckNozzleCheckTypeA ( uidb, keyStr ) != 0 ){
		goto EXIT;
	}
...
static void NozzleCheckTypeAWithoutCheckPattern ( LPUIDB uidb, char *keyStr )
{
	if ( PrintNozzleCheckTypeA ( uidb, keyStr ) != 0 ){
		goto EXIT;
	}
...
// 2008/11/28
static int PrintNozzleCheckTypeB ( LPUIDB uidb, char *keyStr )
{
	GtkWidget* nozzle_check_dialog = NULL;
	GtkWidget *execute_button = NULL;
	int return_val = -1;
	...
	if ( keyStr != NULL ){
		gtk_label_set_text( GTK_LABEL(LookupWidget(nozzle_check_dialog, "nozzle_check_label1")),
			LookupText(g_keytext_list, keyStr ));
	}
	...
	OutputBJLCommandTypeA( BJLNOZZLECHECK, BJLNOZZLECHECKLEN );
...
static void NozzleCheckTypeB ( LPUIDB uidb, char *keyStr )
{
	if ( PrintNozzleCheckTypeB ( uidb, "LUM_IDS_MNTMSG_PATTERNCHECKPRE_07" ) != 0 ){
		goto EXIT;
	}
	if ( CheckNozzleCheckTypeA ( uidb, keyStr ) != 0 ){
		goto EXIT;
...
static void NozzleCheckTypeBWithoutCheckPattern( LPUIDB uidb, char *keyStr )
{
	if ( PrintNozzleCheckTypeB ( uidb, "LUM_IDS_MNTMSG_PATTERNCHECKPRE_07" ) != 0 ){
		goto EXIT;
	}
...
void UtilNozzleCheck(LPUIDB uidb)
{
	...
	if( !strcmp(model_name, IDM_IP_2500) || !strcmp(model_name, IDM_IP_1800) ||
		...
		else if ( !strcmp(model_name, IDM_IP_2600) ) { 
			gtk_label_set_text(
				GTK_LABEL(LookupWidget(nozzle_check_dialog, "nozzle_check_label1")),
		...
		*p = 0x00;
		...
		if (result != ID_CANCEL)
			UtilCleaning(uidb);
			 ...
			 !strcmp(model_name, IDM_MP_610) ||
			 !strcmp(model_name, IDM_IP_100) ||
			 !strcmp(model_name, IDM_MP_190) ||	
			 !strcmp(model_name, IDM_MP_240)){ // 2008/11/28
		...
		if ( !strcmp(model_name, IDM_MP_160) || !strcmp(model_name, IDM_IP_3300) ||
		...
		else if ( !strcmp(model_name, IDM_IP_3500) || !strcmp(model_name, IDM_MP_210) || !strcmp(model_name, IDM_MP_190) ){
			gtk_label_set_text(
				GTK_LABEL(LookupWidget(nozzle_check_dialog, "nozzle_check_label1")),
				LookupText(g_keytext_list, "LUM_IDS_MNTMSG_PATTERNCHECKPRE_LEVERLEFT_07"));
		}
			...
			!strcmp(model_name, IDM_MX_320) || !strcmp(model_name, IDM_MX_330) ) {  // 2008/11/28
			gtk_label_set_text(
				GTK_LABEL(LookupWidget(nozzle_check_dialog, "nozzle_check_label1")),
				LookupText(g_keytext_list, "LUM_IDS_MNTMSG_PATTERNCHECKPRE_07"));
		}
	...
	else if ( !strcmp(model_name, IDM_IP_3600) || !strcmp(model_name, IDM_IP_4600) ||
		!strcmp(model_name, IDM_MP_540) || !strcmp(model_name, IDM_MP_630)  ||
		!strcmp(model_name, IDM_MX_860) ||
		!strcmp(model_name, IDM_MP_550) || !strcmp(model_name, IDM_MP_560) || 
		!strcmp(model_name, IDM_IP_4700) || !strcmp(model_name, IDM_MP_640) ||
		!strcmp(model_name, IDM_MX_870) ){
		NozzleCheckTypeA( uidb, NULL  );
	}
	else if ( !strcmp(model_name, IDM_MX_320) || !strcmp(model_name, IDM_MX_330) ||
			  !strcmp(model_name, IDM_MP_250) || !strcmp(model_name, IDM_MP_270) || !strcmp(model_name, IDM_MP_490) ||
			  !strcmp(model_name, IDM_IP_2700) || !strcmp(model_name, IDM_MX_340) || !strcmp(model_name, IDM_MX_350) ){
		NozzleCheckTypeB( uidb, NULL  );
	}
	else {
		return;
	}
...
static void UtilNozzleCheckWithoutCheckPattern(LPUIDB uidb)
{
	...
	if ( !strcmp(model_name, IDM_MX_860)  || 
		...
		!strcmp(model_name, IDM_IP_4700) || !strcmp(model_name, IDM_MP_640) ||
		!strcmp(model_name, IDM_MX_870)){
		NozzleCheckTypeAWithoutCheckPattern( uidb, NULL ); 
	}
	else if ( !strcmp(model_name, IDM_MX_320) || !strcmp(model_name, IDM_MX_330) ||	
			  !strcmp(model_name, IDM_MP_250) || !strcmp(model_name, IDM_MP_270) || !strcmp(model_name, IDM_MP_490) ||
			  !strcmp(model_name, IDM_IP_2700) || !strcmp(model_name, IDM_MX_340) || !strcmp(model_name, IDM_MX_350) ){
		NozzleCheckTypeBWithoutCheckPattern( uidb, NULL ); 
	}
	else {
		return;
	}
...
void RegiTypeIAutoWithSwitchMsg( LPUIDB uidb, gchar *msgid )
{
	...
	gtk_label_set_text( GTK_LABEL(LookupWidget(head_alignment_dialog, "head_alignment_type_a1_label1")),
		LookupText(g_keytext_list, msgid));
...
{
	RegiTypeIAutoWithSwitchMsg( uidb, "LUM_IDS_MNTMSG_PHA_START_AUTOMATIC_MP1_07" );
}
...
void RegiTypeJAuto( LPUIDB uidb )
{
	GtkWidget *head_alignment_dialog;
	GtkWidget *execute_button;

#ifdef USE_LIB_GLADE
	head_alignment_dialog = LookupWidget(NULL, "regi_auto_type_a1_dialog");
#else
	head_alignment_dialog = create_regi_auto_type_a1_dialog();
#endif
	gtk_widget_realize(head_alignment_dialog);

	/* draw string to label */
	gtk_label_set_text( GTK_LABEL(LookupWidget(head_alignment_dialog, "regi_auto_type_a1_label1")),
		LookupText(g_keytext_list, "LUM_IDS_MNTMSG_PHA_GUIDE_FROD"));

	/* show dialog */
	gtk_widget_show(head_alignment_dialog);
	gtk_window_set_transient_for(GTK_WINDOW(head_alignment_dialog),
				 GTK_WINDOW(UI_DIALOG(g_main_window)->window));
	execute_button = LookupWidget(head_alignment_dialog, "regi_auto_type_a1_cancel_button");
	gtk_widget_grab_focus(execute_button);
...
void RegiTypeJManual( LPUIDB uidb )
{
	GtkWidget *head_alignment_dialog;
	...
	/* draw string to label */		
	gtk_label_set_text( GTK_LABEL(LookupWidget(head_alignment_dialog, "head_alignment_type_a1_label1")),
		LookupText(g_keytext_list, "LUM_IDS_MNTMSG_PHA_START2_3P_07"));

	/* hide radio button and under label  */
	button = LookupWidget(head_alignment_dialog, "head_alignment_type_a1_radiobutton1" );
	gtk_widget_hide( GTK_WIDGET(button) );
	button = LookupWidget(head_alignment_dialog, "head_alignment_type_a1_radiobutton2" );
	gtk_widget_hide( GTK_WIDGET(button) );
	label = LookupWidget(head_alignment_dialog, "head_alignment_type_a1_label2" );
	gtk_widget_hide( GTK_WIDGET(label) );
	...
	gtk_widget_show(head_alignment_dialog);
	gtk_window_set_transient_for(GTK_WINDOW(head_alignment_dialog), GTK_WINDOW(UI_DIALOG(g_main_window)->window));
	button = LookupWidget(head_alignment_dialog, "head_alignment_type_a1_execute_button");
	gtk_widget_grab_focus(button);
	...
	/* output BJL (Print test pattern 1) */
	OutputBJLCommandTypeA( BJLREGI1, BJLREGI1LEN );
	...
	OutputBJLCommandTypeA( BJLREGI2, BJLREGI2LEN );

	UtilMessageBox(LookupText(g_keytext_list, "utility_message_6"), g_window_title, MB_ICON_EXCLAMATION | MB_OK);

	/* Second Print Head Alignment Dialog -----------------------------------------------------*/
	nPageNum = 1;
	if (UtilRegiDialogWithSwitchPermitCancel(nPageNum, isPermitCancel, "regi_type_j2_cancel_button") != ID_OK) goto EXIT ;
	...
	OutputBJLCommandTypeA( BJLREGI3, BJLREGI3LEN );

	UtilMessageBox(LookupText(g_keytext_list, "utility_message_6"), g_window_title, MB_ICON_EXCLAMATION | MB_OK);

	/* Third Print Head Alignment Dialog -----------------------------------------------------*/
	nPageNum = 2;
	if (UtilRegiDialogWithSwitchPermitCancel(nPageNum, isPermitCancel, "regi_type_j3_cancel_button") != ID_OK) goto EXIT ;						
...
void RegiTypeKAuto( LPUIDB uidb )
{
	RegiTypeIAutoWithSwitchMsg( uidb, "LUM_IDS_MNTMSG_PHA_START_AUTOMATIC_MP1_09" );
}
...
void UtilHeadAdjust(LPUIDB uidb)
{
	...
	if( !strcmp(model_name,IDM_IP_2500) || !strcmp(model_name,IDM_IP_1800) ||
		!strcmp(model_name,IDM_IP_2600) || !strcmp(model_name,IDM_IP_1900) )
	{
		int 	n;
		int fname_length;
		char fnamebuf[256];
	...
	else if( !strcmp(model_name,IDM_MP_160) || !strcmp(model_name,IDM_MP_140) )
	{
		...
		*p = 0x00;
		...
		!strcmp(model_name,IDM_MP_190) || !strcmp(model_name,IDM_MP_240) ||
		!strcmp(model_name,IDM_MX_320) || !strcmp(model_name,IDM_MX_330) ) // 2008/11/28
	{
		GtkWidget *head_alignment_dialog;
		GtkWidget *execute_button;
	...
	else if( !strcmp(model_name, IDM_IP_4500) || !strcmp(model_name, IDM_MP_610) )
	{
		...
		*p = 0x00;			
	...
	else if( !strcmp(model_name, IDM_IP_3600) ){ 
		isPermitCancel = 1;
		RegiTypeIManual( uidb );
	}
	else if( !strcmp(model_name, IDM_MP_540) || !strcmp(model_name, IDM_MX_860) ){
		RegiTypeIManual( uidb );
	}
	else if( !strcmp(model_name, IDM_IP_4600) || !strcmp(model_name, IDM_MP_630) ){ 
		...
		if ( manual_head_mode == 0 ){	
			...
			RegiTypeJManual( uidb );
		}
	}
	else if ( !strcmp(model_name, IDM_MP_550) || !strcmp(model_name, IDM_MP_560) ||
			  !strcmp(model_name, IDM_MX_870) ){
		if ( manual_head_mode == 0 ){	
			RegiTypeJAuto( uidb );
		}
	...
	else if ( !strcmp(model_name, IDM_IP_4700) || !strcmp(model_name, IDM_MP_640) ){
		if ( manual_head_mode == 0 ){	
			RegiTypeKAuto( uidb );
		}
		else {
	...
	else if ( !strcmp(model_name, IDM_IP_2700) ) {
			RegiTypeJManual( uidb );
	}
	else return ;
}
...
void UtilRollerCleaning(LPUIDB uidb)
{
	...
	if( !strcmp(model_name, IDM_MP_160) ||
		...
		!strcmp(model_name, IDM_MX_320 ) || !strcmp(model_name, IDM_MX_330 ) ||
		!strcmp(model_name, IDM_MP_250 ) || !strcmp(model_name, IDM_MP_270 ) || !strcmp(model_name, IDM_MP_490 ) || 
		!strcmp(model_name, IDM_IP_2700) || !strcmp(model_name, IDM_MX_340) || !strcmp(model_name, IDM_MX_350) ){
		RollerCleaningTypeB();
	}
	else if ( !strcmp(model_name, IDM_IP_3600 ) || !strcmp(model_name, IDM_IP_4600 ) || 
			  !strcmp(model_name, IDM_IP_4700 )  ){
		RollerCleaningTypeA( 0 );
	}
	else if ( !strcmp(model_name, IDM_MP_540 ) || !strcmp(model_name, IDM_MP_630 ) || !strcmp(model_name, IDM_MX_860 ) ||
			  !strcmp(model_name, IDM_MP_550 ) || !strcmp(model_name, IDM_MP_560 ) || !strcmp(model_name, IDM_MP_640 ) ||
			  !strcmp(model_name, IDM_MX_870 )){
...
void UtilPowerOff(LPUIDB uidb)
{
	...
	if(UtilMessageBox(LookupText(g_keytext_list, "utility_message_8"),
		...
		memcpy(p, BJLEND, BJLENDLEN);p+=BJLENDLEN;
		*p = 0x00; p++;
		//totalBytes = BJLLEN+BJLSTARTLEN+BJLPOWEROFFLEN+BJLENDLEN+1;
		totalBytes = (int)(p - buf);
		PutDeviceData(buf, totalBytes, "POWEROFF");
	}
}
...
void UtilSetConfig(LPUIDB uidb)
{
	...
	if (!strcmp(model_name, IDM_MP_160) ||
		...
		!strcmp(model_name, IDM_IP_4500) || !strcmp(model_name, IDM_MP_610) ||
		!strcmp(model_name, IDM_IP_100) || !strcmp(model_name, IDM_IP_2600) ||
		!strcmp(model_name, IDM_IP_3600) || !strcmp(model_name, IDM_IP_4600) ||	
		!strcmp(model_name, IDM_MP_540) || !strcmp(model_name, IDM_MP_630) ||
		!strcmp(model_name, IDM_MP_240) || !strcmp(model_name, IDM_MP_190) ||
		!strcmp(model_name, IDM_IP_1900) ||
		!strcmp(model_name, IDM_MX_860) || !strcmp(model_name, IDM_MX_320) || !strcmp(model_name, IDM_MX_330) ||
		!strcmp(model_name, IDM_MP_250) || !strcmp(model_name, IDM_MP_270) || !strcmp(model_name, IDM_MP_490) ||// 2009/04/20
		!strcmp(model_name, IDM_MP_550) || !strcmp(model_name, IDM_MP_560) || 
		!strcmp(model_name, IDM_IP_4700) || !strcmp(model_name, IDM_MP_640) ||
		!strcmp(model_name, IDM_IP_2700) || !strcmp(model_name, IDM_MX_340) || !strcmp(model_name, IDM_MX_350) ||
		!strcmp(model_name, IDM_MX_870) ){ 
...
void UtilPlateCleaning(LPUIDB uidb)
{
	...
	if ( !strcmp(model_name, IDM_MP_160) ||		
			  ...
			  !strcmp(model_name, IDM_IP_2500) || !strcmp(model_name, IDM_IP_1800) ||
		   	  ...
		   	  !strcmp(model_name, IDM_MP_550) || !strcmp(model_name, IDM_MP_560) || 
		   	  !strcmp(model_name, IDM_IP_4700) || !strcmp(model_name, IDM_MP_640) ||
		   	  !strcmp(model_name, IDM_IP_2700) || !strcmp(model_name, IDM_MX_340) ||
		   	  !strcmp(model_name, IDM_MX_350) || !strcmp(model_name, IDM_MX_870)  ) {
		GtkWidget*	label;
		gchar*		msg;
		int n;	
		...
		if ( !strcmp(model_name, IDM_IP_100) ){  
...
void UtilInkCartridgeSet( LPUIDB uidb )
{
	...
	else if ( !strcmp(model_name, IDM_IP_2600) ||  !strcmp(model_name, IDM_MP_240) ||
			!strcmp(model_name, IDM_MP_190)	|| !strcmp(model_name, IDM_IP_1900) ||
			!strcmp(model_name, IDM_MX_320) || !strcmp(model_name, IDM_MX_330) ){ 
		inkcartridge_settings_index = 1;
...
short isAllOutputSetTime( char *modelName )
{
	...
	ptr = AllOutputSetTimeList;
	while( *ptr != NULL ){
		if ( !strcmp(*ptr, modelName) ){
			break;
		}
		ptr++;
	}
