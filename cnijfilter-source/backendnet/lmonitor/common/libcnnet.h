...
/* Command Type */
#define CNNL_COMMAND_IVEC		(0)
#define CNNL_COMMAND_NONIVEC	(1)
...
#define CNNET_SEARCH_CACHE_ALL	(3)			/* added ver.1.10(driver ver.3.20) */
#define CNNET_SEARCH_CACHE_ACTIVEONLY (4)	/* added ver.1.10(driver ver.3.20) */

/* Command Set */
#define CNNET_TYPE_CONTROL		(0)		/* added ver.1.10(driver ver.3.20) */
#define CNNET_TYPE_PRINTER		(1)		/* added ver.1.10(driver ver.3.20) */
#define CNNET_TYPE_MULTIPASS	(2)		/* added ver.1.10(driver ver.3.20) */
#define CNNET_TYPE_STORAGE		(3)		/* added ver.1.10(driver ver.3.20) */

/* functions */

/* for ver.1.00(driver ver.3.10) */
...
/* added at ver.1.10(driver ver.3.20) */
